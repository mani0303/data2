...
namespace MintMailPro\Mint_AES_Encription;

use MintMailPro\Mint_AES\Mint_Aes;

class Mint_Aes_Ctr extends Mint_Aes {
	...
	public static function encrypt( $plaintext, $password, $nBits ) {
		...
		$key = Mint_Aes::cipher( $pwBytes, Mint_Aes::keyExpansion( $pwBytes ) );
		...
		$keySchedule = Mint_Aes::keyExpansion( $key );
		// print_r($keySchedule);
		...
		for ( $b = 0; $b < $blockCount; $b++ ) {
			...
			$cipherCntr = Mint_Aes::cipher( $counterBlock, $keySchedule ); // -- encrypt counter block --
